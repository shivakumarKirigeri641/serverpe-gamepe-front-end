...
export const en = {
  ...
  prizes: {
    ...
    showing: 'Showing',
    tapPrize: 'Tap a prize to see the squares it needs.',
    anyFive: 'Any five squares — position does not matter.',
    items: [
  ...
  pricing: {
    ...
    trialUntil: 'Free for everyone until {date}',
    trialOver: 'The free trial has ended. These are the prices.',
    freeTitle: 'Everything is free until {date}',
    freeBody:
      'Unlimited games, all six prizes, up to 50 players in a room. No payment, no card details, nothing to cancel. We will publish prices here well before anything changes — and tell you in the chat first.',
    freeBadge: 'Free unlimited',
    tableTitle: '24-hour unlimited',
    tableSub: 'One price for the whole day. Play as many games as you like — there is no per-game charge.',
    colBand: 'Capacity',
    colPlayers: 'Players per game',
    colPrice: '24-hour price',
    colPerPlayer: 'Per player',
    popular: 'Popular',
    bands: {
      10: 'Mini',
      25: 'Starter',
    ...
    gstNote: 'All prices include GST. One payment covers 24 hours of unlimited games for that room size — nothing is charged per game.',
    save: 'save {n}%',
