...
export const en = {
  ...
  pricing: {
    ...
    tableTitle: 'What it will cost later',
    tableSub: 'One price per room size. Pick the size, pick one game or the whole day.',
    colPlayers: 'Room size',
    colSingle: 'One game',
    colPass: '24-hour pass',
    save: 'save {n}%',
    gstNote: 'All prices include GST. You are charged for the players who actually joined, never more than the size you picked.',
